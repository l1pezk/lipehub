...
local W = Window:AddTab({ Title = "Welcome", Icon = "rbxassetid://119980140458596" })

local M = Window:AddTab({ Title = "General", Icon = "rbxassetid://119980140458596" })

local ST = Window:AddTab({ Title = "Setting", Icon = "rbxassetid://119980140458596" })

local IQ = Window:AddTab({ Title = "Item & Quest", Icon = "rbxassetid://119980140458596" })

local S = Window:AddTab({ Title = "Stats", Icon = "rbxassetid://119980140458596" })

local E = Window:AddTab({ Title = "ESP", Icon = "rbxassetid://119980140458596" })

local RA = Window:AddTab({ Title = "Raid", Icon = "rbxassetid://119980140458596" })

local LC = Window:AddTab({ Title = "Local Players", Icon = "rbxassetid://119980140458596" })

local Wld = Window:AddTab({ Title = "World Teleport", Icon = "rbxassetid://119980140458596" })

local SV = Window:AddTab({ Title = "Status Sever", Icon = "rbxassetid://119980140458596" })

local D = Window:AddTab({ Title = "Devil Fruit", Icon = "rbxassetid://119980140458596" })

local R = Window:AddTab({ Title = "Race V4", Icon = "rbxassetid://119980140458596" })

local SH = Window:AddTab({ Title = "Shop", Icon = "rbxassetid://119980140458596" })

local C = Window:AddTab({ Title = "Misc", Icon = "rbxassetid://119980140458596" })
...
M:AddDropdown("HqCrvy", {Title = "Select", Values = {}, Multi = false, Default = false, Callback = function(Value) end})
                      tweenz:Play()
                  end)
...
IQ:AddToggle("klXQhG", {Title = "=", Default = false, Callback = function(Value) end})
                OrionLib:MakeNotification({
...
Window:SelectTab(1)
Fluent:Notify({Title='Sucesso', Content='Script Convertido', Duration=5})
