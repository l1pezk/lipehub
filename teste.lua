...
local Window = OrionLib:MakeWindow({Name = "🇧🇷 Lipe Hub", HidePremium = false, IntroText = "", SaveConfig = true, ConfigFolder = "🇧🇷 Lipe Hub"})
