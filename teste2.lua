...
-- [[ TABELA DE CONFIGURAÇÕES (LÓGICA ORIGINAL) ]] --
_G.Settings = {
	Main = {
...
-- [[ FUNÇÕES AUXILIARES E LÓGICA DE COMBATE ]] --
...
-- [[ CONFIGURAÇÃO DE SPAWNS (REMOVIDO PRINTS) ]] --
...
-- [[ SISTEMA DE UPDATE DE VARIÁVEIS GLOBAIS ]] --
spawn(function()
    while wait() do
...
-- [[ FUNÇÃO QUEST CHECK (MANTIDA INTACTA) ]] --
...
-- [[ LOOP DE FARM PRINCIPAL (BRING MOBS) ]] --
spawn(function()
	while task.wait() do
		pcall(function()
...
-- [[ LOOP PRINCIPAL DE LÓGICA DE FARM ]] --
spawn(function()
	while wait() do 
...
-- [[ LOOPS ADICIONAIS DE FAST ATTACK ]] --
...
-- ==============================================================================
-- 3. INTERFACE RAYFIELD (NOVA)
-- ==============================================================================

local Rayfield = loadstring(game:HttpGet('https://sirius.menu/rayfield'))()

local Window = Rayfield:CreateWindow({
   Name = "Silver Hub | Rayfield Edition",
   LoadingTitle = "Silver Hub",
   LoadingSubtitle = "by Gemini",
   ConfigurationSaving = {
      Enabled = true,
      FolderName = "SilverHubConfig",
      FileName = "SilverHubManager"
   },
   Discord = {
      Enabled = false,
      Invite = "noinvitelink", 
...
Rayfield:Notify({
   Title = "Carregado",
   Content = "Script carregado sem erros. Bom jogo!",
   Duration = 5,
   Image = 4483362458,
})
